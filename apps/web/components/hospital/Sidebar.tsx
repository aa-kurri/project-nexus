...
const NAV: NavItem[] = [
  ...
  { label: "IPD",          href: "/ipd",           icon: BedDouble,
    children: [
      ...
      { label: "CPOE",           href: "/ipd/cpoe" },
      { label: "MAR",            href: "/ipd/mar" },
      { label: "ICU Flowsheet",  href: "/ipd/icu" },
    ]},
  ...
  { label: "Pharmacy",    href: "/pharmacy",         icon: Pill,
    children: [
      ...
      { label: "Drug Schedules",  href: "/pharmacy/schedules" },
      { label: "Drug CDS",        href: "/pharmacy/cds" },
    ]},
  ...
  { label: "Billing",     href: "/billing",          icon: Receipt,
    children: [
      ...
      { label: "TPA Cashless",    href: "/billing/tpa" },
      { label: "Revenue Audit",   href: "/billing/audit" },
    ]},
  ...
  { label: "Compliance",  href: "/compliance",       icon: ShieldCheck,
    children: [
      { label: "ABHA / ABDM",      href: "/compliance/abha" },
      { label: "PCPNDT Register",  href: "/compliance/pcpndt" },
      { label: "PMJAY Claims",     href: "/compliance/pmjay" },
