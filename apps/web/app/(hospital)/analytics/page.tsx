...
export default function AnalyticsPage() {
  const modules = [
    { title: "Pharmacy Analytics", desc: "Sales trends, expiry analysis, and margins", icon: PieChart, href: "/analytics/pharmacy" },
    { title: "MIS Reports", desc: "Executive reports for hospital management", icon: BarChart3, href: "/analytics/mis" },
  ];
